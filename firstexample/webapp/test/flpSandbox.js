		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First Example",
									"targetURL": "#firstexamplefirstexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstexamplefirstexample-display": {
								"semanticObject": "firstexamplefirstexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firstexample.firstexample",
									"url": sap.ui.require.toUrl("firstexample/firstexample")
								}
							}
						}
					}
